...
import net.sevoos.rest.patchJson
...
private val restUtility = RestUtility(config.hostContact, config.apiContact, patchJson)
    ...
    suspend fun patchContact(id: Long, patchDto: ContactPatchRequest): ResponseEntity<ContactDto?> =
        restUtility.patchForEntity(PATCH_CONTACT, patchDto, id)
