...
class RestUtility(
    ...
    suspend inline fun <reified T> uploadFileDtoMeta(
        mapping: String,
        fileName: String,
        fileBytes: ByteArray,
        meta: Any,
    ): ResponseEntity<T> = uploadFile(
        mapping,
        fileName,
        fileBytes,
    ...
    suspend inline fun <reified T> uploadFileStringMeta(
        mapping: String,
        fileName: String,
        fileBytes: ByteArray,
        meta: Any,
    ): ResponseEntity<T> = uploadFile<T>(
        mapping,
        fileName,
        fileBytes,
        meta.toString()
